...
internal class SubscriberAwareControllerTest {
    @Test
    fun `controller builder`() = runTest {
        ...
        ) as SubscriberAwareControllerImplementation<Int, Int, Int, Nothing>
        ...
        assertEquals(SharingStarted.Lazily, sut.sharingStarted)
    ...
    fun `effect controller builder`() = runTest {
        ...
        val sut = createEffectController<Int, Int, Int, Int>(
            initialState = expectedInitialState,
            sharingStarted = SharingStarted.Lazily
        ) as SubscriberAwareControllerImplementation<Int, Int, Int, Int>
